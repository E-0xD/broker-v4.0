        ...
        if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), o)) {
            ...
            (g = "scroll" + n.d2),
                X(
                    ...
                    (C && 20 < T) ||
                        (!C &&
                            (u ? Math.max(Je[g], We[g]) : o.parentNode[g]) <=
                                T + 1)
                ),
                u &&
                    ((l = wt(a)),
            ...
            ((ScrollTrigger.prototype.init = function init(M, O) {
                if (
                    ...
                    var A,
                        ...
                        o,
                        C = (M = ob(
                            ct(M) || Ua(M) || M.nodeType ? { trigger: M } : M,
                            Tt
                        )).onUpdate,
                        S = M.toggleClass,
                        a = M.id,
