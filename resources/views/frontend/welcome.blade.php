    ...
    <section class="services-section bg--black py-120">
        <div class="container position-relative">
            <div class="services-shape d-none d-lg-block">
                <img src="{{ asset('frontend/svg/balance-1.svg') }}" alt="balance">
                <img src="{{ asset('frontend/svg/balance-2.svg') }}" alt="balance">
            </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="services-box">
                                    ...
                                    <p>Trade Mastery is more than a trading platform it's a gateway to the
    ...
    <section class="trade-section bg--black-two py-120">
        <div class="container position-relative">
            <div class="trade-shape d-none d-lg-block">
                <img src="{{ asset('frontend/svg/twostar.svg') }}" alt="start">
                <img src="{{ asset('frontend/svg/calculator.svg') }}" alt="start">
            </div>
            <div class="row row-gap-5">
                <div class="col-xl-6 align-self-center">
    ...
    <section class="trade-smartet-section bg--black py-120">
        <div class="container position-relative">
            <div class="trade-smartet-shape d-none d-lg-block">
                <img src="{{ asset('frontend/svg/twostar.svg') }}" alt="star">
                <img src="{{ asset('frontend/svg/balance-3.svg') }}" alt="balance">
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-content text-center">
                            ...
                            <ul class="nav nav-pills order-1 order-xl-0" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="pill"
                                        data-bs-target="#pills-commodities" role="tab">commodities</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="row mt-5 row-gap-5 justify-content-between">
                                <div class="col-xl-5 col-lg-6">
                                    <div class="section-content">
                                        ...
                                        <p>
                                            Trade Mastery, we believe is the great traders aren't born they’re
