                     ...
                     <div class="row row-gap-5">
                         <div class="col-lg-6 align-self-center order-1 order-lg-0">
                             <div class="call-text text-center text-lg-start">
                                 <span class="text--base pb-3">Start Your Journey
                                     Today</span>
                                 <h2 class="mb-4">Learn, Trade, And Grow With Trusted Tools
                                     And
                                     Signals.</h2>
                         ...
                         <div class="col-lg-6 align-self-center">
                             <div class="call-img text-lg-end text-center">
                                 <img src="{{ asset('frontend/images/call/call-img.png') }}" alt="call"
