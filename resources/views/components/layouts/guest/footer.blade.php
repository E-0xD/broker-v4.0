                   ...
                   <div class="col-xl-4 col-lg-6">
                       <div class="footer-item footer-logo-con pe-xl-5">
                           <div class="footer-item__logo">
                               <a href="{{route('home')}}"> <img src="{{asset(config('app.logo'))}}" alt="logo"></a>
                           </div>
                           <p class="footer-item__desc">
                               {{config('app.name')}}, we believe is the great traders aren't born they’re built through
                               the
                               right
                       ...
                       <div class="footer-widget__content ">
                           <div class="footer-item">
                               ...
                               <ul class="footer-menu">
                                   ...
                                   <li class="footer-menu__item"> <a href="{{route('about')}}" class="footer-menu__link">
                                          About Us
                                       </a> </li>
                                   <li class="footer-menu__item"> <a href="{{route('pricing')}}" class="footer-menu__link">
                                           Pricing Plan
                                       </a> </li>
