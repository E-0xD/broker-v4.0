<x-layouts.app>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="d-flex card-header justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                <a href="#"
                                    class="dropdown-toggle bg-light-subtle rounded drop-arrow-none card-drop"
                        ...
                        <div class="card-body pt-0">
                            <h2 class="fw-bold">$92,652.36 <a href="#!" class="text-muted"><i
                                        class="ti ti-eye"></i></a></h2>

                            <div class="row g-2 mt-2 pt-1">
                                <div class="col">
                                    <a href="#!" class="btn btn-primary w-100"><i class="ti ti-coin me-1"></i>
                                        Transfer</a>
                                </div>
                                <div class="col">
                                    <a href="#!" class="btn btn-info w-100"><i class="ti ti-coin me-1"></i>
                                        Request</a>
                                </div>
                            </div>
                        </div> <!-- end card-body -->
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-sm-7 text-end d-flex flex-column">
                                    <a href="javascript:void(0);"
                                        class="link-reset text-decoration-underline link-offset-2 fw-medium pb-2">
                                        View Details
                                    </a>
                            ...
                            <div>
                                <div class="input-group">
                                    <input type="text" class="form-control" data-provider="flatpickr"
                                        data-deafult-date="Jun to Aug" data-date-format="M Y" data-range-date="true">
                                    ...
                                    <div class="carousel-item active">
                                        <div class="card bg-primary shadow-none rounded-4">
                                            <div class="card-body">
                                                ...
                                                <div class="row mt-4 align-items-center">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="text-end">
                                                            <img src="dashboard/images/cards/visa-white.svg"
                                                                alt="" height="20" class="me-1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div>
                                                ...
                                                <h4 class="fs-18">$38562.25 <small class="text-muted">USD</small>
                                                </h4>
                                            </div>
                                            <a href="javascript:void(0);"
                                        ...
                                        <div class="card bg-success rounded-4">
                                            <div class="card-body">
                                                ...
                                                <div class="row mt-4 align-items-center">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="text-end">
                                                            <img src="dashboard/images/cards/discover-white.svg"
                                                                alt="" height="16" class="me-1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-1 justify-content-center">
                                <div class="avatar">
                                    <img src="dashboard/images/users/avatar-4.jpg" data-bs-toggle="tooltip"
                                        data-bs-title="Alexa Newsome" alt=""
                                        class="rounded-circle img-thumbnail avatar-lg">
                                </div>
                                <div class="avatar">
                                    <img src="dashboard/images/users/avatar-5.jpg" data-bs-toggle="tooltip"
                                        data-bs-title="Shelly Dorey" alt=""
                                        class="rounded-circle img-thumbnail border-primary avatar-lg">
                                </div>
                                <div class="avatar">
                                    <img src="dashboard/images/users/avatar-3.jpg" data-bs-toggle="tooltip"
                                        data-bs-title="Fredrick Arnett" alt=""
                                        class="rounded-circle img-thumbnail avatar-lg">
                                </div>
                                <div class="avatar">
                                    <img src="dashboard/images/users/avatar-8.jpg" data-bs-toggle="tooltip"
                                        data-bs-title="Barbara Frink" alt=""
                                        class="rounded-circle img-thumbnail avatar-lg">
                                </div>
                                <div class="avatar">
                                    <img src="dashboard/images/users/avatar-2.jpg" data-bs-toggle="tooltip"
                                        data-bs-title="Adam M" alt=""
                                        class="rounded-circle img-thumbnail avatar-lg">
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap align-items-center gap-2">
                    <h4 class="header-title me-auto">Transactions <span class="text-muted fw-normal fs-14">(95.6k+
                        ...
                        <table class="table table-borderless table-hover table-custom table-nowrap align-middle mb-0">
                            <thead class="bg-light bg-opacity-50 thead-sm">
                                <tr class="text-uppercase fs-12">
                                    ...
                                    <th scope="col" class="text-muted">Name / Business</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#!" class="fw-medium text-reset">#DK801</a>
                                    </td>
                                    <td>
                                        <div class="avatar-xs d-inline-block me-1">
                                            <span
                                                class="avatar-title bg-primary-subtle text-primary fw-semibold rounded-circle">
                                                A
                                            </span>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td><img src="dashboard/images/users/avatar-2.jpg" alt=""
                                            class="avatar-xs rounded-circle me-1">
                                        <a href="#javascript: void(0);" class="text-reset align-middle">Alexa
                                            Newsome</a>
                                    </td>
                                    <td>Invoice #1908</td>
                                    ...
                                    <td>Debit</td>
                                    <td>
                                        <img src="dashboard/images/cards/visa.svg" alt="" height="24"
                                            class="me-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="dashboard/images/cards/payoneer.svg" alt="" height="24"
                                            class="me-1">
                                ...
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <img src="dashboard/images/cards/unionpay.svg" alt="" height="24"
                                            class="me-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-xs d-inline-block me-1">
                                            <span
                                                class="avatar-title bg-secondary-subtle text-secondary fw-semibold rounded-circle">
                                                S
                                            </span>
                                        </div>
                                    ...
                                    <td>Credit</td>
                                    <td>
                                        <img src="dashboard/images/cards/paypal.svg" alt="" height="24"
                                            class="me-1">
                                ...
                                <tr>
                                    ...
                                    <td><img src="dashboard/images/users/avatar-5.jpg" alt=""
                                            class="avatar-xs rounded-circle me-1">
                                        <a href="#javascript: void(0);" class="text-reset align-middle">Fredrick
                                            Arnett</a>
                                    </td>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <img src="dashboard/images/cards/stripe.svg" alt="" height="24"
                                            class="me-1">
                                ...
                                <tr>
                                    ...
                                    <td><img src="dashboard/images/users/avatar-4.jpg" alt=""
                                            class="avatar-xs rounded-circle me-1">
                                        <a href="#javascript: void(0);" class="text-reset align-middle">Barbara
                                            Frink</a>
                                    </td>
                    ...
                    <div class="align-items-center justify-content-between row text-center text-sm-start">
                        <div class="col-sm">
                            <div class="text-muted">
                                Showing <span class="fw-semibold text-body"> 7 </span> of <span class="fw-semibold">
                                    15 </span> Transactions
                            </div>
                        </div>
